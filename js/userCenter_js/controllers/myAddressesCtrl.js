angular.module('LuckyMall.controllers')
    ...
    ['$scope', '$state', '$stateParams', 'AddressSer', '$timeout', 'LoginSer',
        function ($scope, $state, $stateParams, AddressSer, $timeout, LoginSer) {
            ...
            $scope.addAddress = function () {
                if ($scope.new_area == '') {
                    ...
                    if ($scope.new_address == '' | $scope.new_address == undefined) {
                        $scope.tips.inputAddressTip = '请输入详细地址';
                        return;
                    } else {
                        if ($scope.new_consignee == '' || $scope.new_consignee == undefined) {
                            $scope.tips.inputConsigneeTip = '请输入收货人姓名';
                            return;
                        } else {
                            if ($scope.new_mobile == '' | $scope.new_mobile == undefined) {
                                $scope.tips.inputMobileTip = '请输入收货人手机号码';
                                return;
                            }
                        }
                    }
