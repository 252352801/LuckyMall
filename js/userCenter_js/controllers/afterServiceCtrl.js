angular.module('LuckyMall.controllers')
    ...
    ['$scope','$state', '$stateParams', 'MyOrdersSer', '$timeout', 'AddressSer', 'LoginSer', 'FileUploader', 'UploadSer', 'OrderDetailsSer', 'LogisticsSer',
        function ($scope, $state, $stateParams, MyOrdersSer, $timeout, AddressSer, LoginSer, FileUploader, UploadSer, OrderDetailsSer, LogisticsSer) {
            ...
            $scope.submit = function () {
                ...
                for (var o in $scope.uploader.queue) {
                    if ($scope.uploader.queue[o].imgUrl) {
                        var img_url = $scope.uploader.queue[o].imgUrl;
                        if (o < len - 1) {
                            img_url += '|';
                        }
