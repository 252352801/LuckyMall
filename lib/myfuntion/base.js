...
function tweenMove(paramter){
    ...
    function Run(){
        ...
        if(moveName!='Linear') {
            if(attr!='opacity'){
                if(attr=='scrollTop'||attr=='scrollLeft'){
                    obj[attr] = Math.ceil(animate[moveName][moveType](t, b, c, d));
                }else{
                    obj.style[attr] = Math.ceil(animate[moveName][moveType](t, b, c, d)) + "px";
                }
            }else{
                obj.style[attr] = Math.ceil(animate[moveName][moveType](t, b, c,d))/100;
            }
        }else{
            if(attr!='opacity'){
                if(attr=='scrollTop'||attr=='scrollLeft') {
                    obj[attr] = Math.ceil(animate[moveName](t, b, c, d));
                }else{
                    obj.style[attr] = Math.ceil(animate[moveName](t, b, c, d)) + "px";
                }
            }else{
                obj.style[attr] = Math.ceil(animate[moveName](t, b, c,d))/100;
            }
        }
        if(t<d){
            t++;
            ...
            if (moveName != 'Linear') {
                if (obj[o].attr != 'opacity') {
                    if (obj[o].attr == 'scrollTop' || obj[o].attr == 'scrollLeft') {
                        ele[obj[o].attr] = Math.ceil(animate[moveName][moveType](t, b, c, d));
                    } else {
                        ele.style[obj[o].attr] = Math.ceil(animate[moveName][moveType](t, b, c, d)) + "px";
                    }
                } else {
                    ele.style[obj[o].attr] = Math.ceil(animate[moveName][moveType](t, b, c, d)) / 100;
                }
            } else {
                if (obj[o].attr != 'opacity') {
                    if (obj[o].attr == 'scrollTop' || obj[o].attr == 'scrollLeft') {
                        ele[obj[o].attr] = Math.ceil(animate[moveName](t, b, c, d));
                    } else {
                        ele.style[obj[o].attr] = Math.ceil(animate[moveName](t, b, c, d)) + "px";
                    }
                } else {
                    ele.style[obj[o].attr] = Math.ceil(animate[moveName](t, b, c, d)) / 100;
                }
            }
        }
        if (t < d) {
            ...
            for(var i in obj[o].object) {
                ...
                if (moveName != 'Linear') {
                    if (attr_name != 'opacity') {
                        if (attr_name == 'scrollTop' || attr_name == 'scrollLeft') {
                            ele[attr_name] = Math.ceil(animate[moveName][moveType](t, b, c, d));
                        } else {
                            ele.style[attr_name] = Math.ceil(animate[moveName][moveType](t, b, c, d)) + "px";
                        }
                    } else {
                        ele.style[attr_name] = Math.ceil(animate[moveName][moveType](t, b, c, d)) / 100;
                    }
                } else {
                    if (attr_name != 'opacity') {
                        if (attr_name == 'scrollTop' || attr_name == 'scrollLeft') {
                            ele[attr_name] = Math.ceil(animate[moveName](t, b, c, d));
                        } else {
                            ele.style[attr_name] = Math.ceil(animate[moveName](t, b, c, d)) + "px";
                        }
                    } else {
                        ele.style[attr_name] = Math.ceil(animate[moveName](t, b, c, d)) / 100;
                    }
                }
            }
        }
