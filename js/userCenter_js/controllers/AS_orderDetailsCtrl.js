angular.module('LuckyMall.controllers')
    ...
    ['$scope','$state', '$stateParams', 'AS_OrderDetailsSer', 'LogisticsSer', 'MyOrdersSer', 'ASOrderDetailsSer',
        function ($scope, $state, $stateParams, AS_OrderDetailsSer, LogisticsSer, MyOrdersSer, ASOrderDetailsSer) {
